...
| `DRIVING_SITE(<tbl_alias>)`        | При соединениях по db-link указывает на какой стороне выполнять соединение (указывается таблица с наименьшим количеством строк отбираемых в запросе) | Управление методом соединения в специфических конструкциях.                                                                                |
