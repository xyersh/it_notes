...
### Ключевые требования к хэшированию в фильтре Блума

1. **Несколько «независимых» хэш-значений** — фильтр Блума требует `k` различных позиций в битовом массиве для каждого элемента.
2. **Равномерное распределение** — чтобы минимизировать коллизии и ложные срабатывания.
3. **Быстродействие** — особенно если вы обрабатываете большие объёмы данных.
