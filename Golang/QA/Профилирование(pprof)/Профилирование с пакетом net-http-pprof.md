...
### База
**Профилирование** — это процесс сбора и анализа данных о работе программы с целью выявления узких мест в производительности. Проще говоря, это способ понять, какие части кода работают медленно или потребляют слишком много ресурсов (например, памяти).
...
- **Heap/Allocs Profile**: Показывает, какие участки кода выделяют больше всего памяти в "куче" (heap).
