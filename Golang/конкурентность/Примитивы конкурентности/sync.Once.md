...
- **Если первая функция упала с паникой** остальные внутри sync.Once все равно не будут выполнены. Поэтому ВАЖНО следить за возможностью возникновения паник внутри запускаемых внутри sync.Once функций.
