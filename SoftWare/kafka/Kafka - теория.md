...
- **Broker**  - инстантс брокера, работающий на конкретной железяке (ну или на виртуальной машине)
- **Cluster** - несколько брокеров, совместно работающих  на нескольких машинах(cерверах). Кластер обеспечивает дополнительную надежность работы (если 1 брокер умрет - его функции возьмут на себя остальные работающие) + увеличение производительности (за счет увеличения хардварных мощностей )
