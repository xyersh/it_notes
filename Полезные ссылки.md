...
- [EbookFoundation](https://github.com/EbookFoundation/free-programming-books/blob/main/books/free-programming-books-ru.md) - список бесплатных книг о свяком из мира IT
...
- [https://nowinterview.ru](https://nowinterview.ru)- годнота по алгоритмам и Сис Дизу.
### Golang
...
### Софты
- [excalidraw](https://excalidraw.com/)- очень удобная рисовалка диаграмм и схем
- [craft](https://www.craft.do/)- ведение заметок задач, календарь и AI в одном приложении, помогая быстрее готовиться к встречам и организовывать работу
- [pieces](https://pieces.app/) - AI-память для разработчика, которая помогает находить забытые сниппеты, ссылки и полезную информацию за секунды
