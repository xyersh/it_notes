...
### Таблица сигналов ОС для завершения приложения

| Сигнал  | Как вызывается      | Можно перехватить? | Что происходит?                |
| ------- | ------------------- | ------------------ | ------------------------------ |
| SIGINT  | Ctrl + C            | Да                 | Пользователь хочет остановить  |
| SIGTERM | 'kill' в Kubernetes | Да                 | "Вежливая просьба завершиться" |
| SIGKILL | Kill -9             | Нет                | Мгновенная смерть процесса     |
