```sql
 select COUNT(DISTINCT a3.issue_id) as done_in_time                                                                                                                                                 
 from (                                                                                                                                                                                          
  select a2.issue_id, a2.done_time, CONCAT(a2.plan_date," 23:59:58") as plan_date                                                                                                                   
      from (                                                                                                                                                                                        
  ...
  where a2.plan_date != ""                                                                                                                                                                          
  and a2.plan_date >= :date1                                                                                                                                                                            
 )a3                                                                                                                                                                                                
 where a3.done_time <= a3.plan_date                                                                                                                                                                 
```